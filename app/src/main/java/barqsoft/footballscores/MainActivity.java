...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CrestImageLoader.initSvgRequestBuilder(this);
        ...
        my_main = (MainFragment)getSupportFragmentManager().findFragmentById(R.id.fragment);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            ApiFetchService.updateScores(this);
            return true;
        }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState)
    {
        ...
        my_main = (MainFragment) getSupportFragmentManager().getFragment(savedInstanceState,"my_main");
